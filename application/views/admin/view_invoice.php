<?php  $this->load->view('index/header');
 ...
 <?php 
  ...
  foreach ($get_remaining_balance as $data)
   {
    if ($data->main_invoice_id == $main_invoice_id){
            break;
      }
...
<table class="table table-responsive">
  <thead>
    <tr>
      ...
      <th scope="col" class="print_hide">D%</th> 
...
?>
    <tr>
      ...
      <td><?php echo  $rate;?></td> 
      <td class="print_hide"><?php echo  $invoice_discount;?></td> 
  ...
  <thead>
    <tr>
      ...
      <td scope="col" class="print_hide"></td>
      <td scope="col"></td>
     ...
     <tr>
      ...
      <td scope="col"></td>
      <td scope="col"></td>
      <td scope="col" style="text-align: right;">Previous balance</td> 
      <td scope="col" style="text-align: right;"><b><?php echo number_format($get_remaining_credit);?></b></td>
       <td scope="col"></td>
     ...
     <tr>
      ...
      <td scope="col" class="print_hide"></td>
      <td scope="col"></td>
      <td scope="col" style="text-align: right;">Sub Total</td> 
      <td scope="col" style="text-align: right;"><b><?php echo number_format($get_remaining_credit + $main_i_debit);?></b></td>
       <td scope="col"></td>
